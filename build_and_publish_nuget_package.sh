...
project_src_dir='./src/Mvc.Routing'
build_mode='Release'
...
# build project
$msbuild $project_src_dir/Mvc.Routing.csproj /property:Configuration=$build_mode > $build_log
